...
export default function Feed() {
    ...
    const getmyAddress = async (lat, lng) => {
        try {
            ...
            setSiGuDong(data);
            feedsPopularity(lat, lng, data.si, data.gu, data.dong);
    ...
    const [feedsPopularityArr, setFeedsPopularity] = React.useState(null);

    const feedsPopularity = (lat, lng, si, gu, dong) => {
        console.log(lat, lng, si, gu, dong);
        FeedsService.feedsPopularityAxios(si, gu, dong, lat, lng)
            .then((res) => {
                console.log(res);
